...
namespace Day02.studentDBDataSet2TableAdapters {
...
SELECT mssv, firstName, lastName, phone, address, birthDay, gender, pirture, major, email FROM students WHERE (mssv = @mssv)";
        ...
        public virtual int Fill(studentDBDataSet2.studentsDataTable dataTable) {
        ...
        public virtual studentDBDataSet2.studentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            studentDBDataSet2.studentsDataTable dataTable = new studentDBDataSet2.studentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(studentDBDataSet2.studentsDataTable dataTable) {
