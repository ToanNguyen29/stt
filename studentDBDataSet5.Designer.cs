...
namespace Day02 {
    ...
    public partial class studentDBDataSet5 : global::System.Data.DataSet {
        ...
        public partial class teachersDataTable : global::System.Data.TypedTableBase<teachersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public teachersRow AddteachersRow(string email, string fname, string sname, string phone, string address, System.DateTime birthDay, string gender, string country) {
...
namespace Day02.studentDBDataSet5TableAdapters {
    ...
    public partial class teachersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[teachers] WHERE (([teacherID] = @Original_teacherID) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_sname = 1 AND [sname] IS NULL) OR ([sname] = @Original_sname)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ([birthDay] = @Original_birthDay) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_country = 1 AND [country] IS NULL) OR ([country] = @Original_country)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[teachers] ([email], [fname], [sname], [phone], [address], [birthDay], [gender], [country]) VALUES (@email, @fname, @sname, @phone, @address, @birthDay, @gender, @country);
SELECT teacherID, email, fname, sname, phone, address, birthDay, gender, country FROM teachers WHERE (teacherID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[teachers] SET [email] = @email, [fname] = @fname, [sname] = @sname, [phone] = @phone, [address] = @address, [birthDay] = @birthDay, [gender] = @gender, [country] = @country WHERE (([teacherID] = @Original_teacherID) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_sname = 1 AND [sname] IS NULL) OR ([sname] = @Original_sname)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ([birthDay] = @Original_birthDay) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_country = 1 AND [country] IS NULL) OR ([country] = @Original_country)));
SELECT teacherID, email, fname, sname, phone, address, birthDay, gender, country FROM teachers WHERE (teacherID = @teacherID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT teacherID, email, fname, sname, phone, address, birthDay, gender, country " +
                "FROM dbo.teachers";
        ...
        public virtual int Fill(studentDBDataSet5.teachersDataTable dataTable) {
        ...
        public virtual studentDBDataSet5.teachersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            studentDBDataSet5.teachersDataTable dataTable = new studentDBDataSet5.teachersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(studentDBDataSet5.teachersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_teacherID, string Original_email, string Original_fname, string Original_sname, string Original_address, System.DateTime Original_birthDay, string Original_gender, string Original_country) {
        ...
        public virtual int Insert(string email, string fname, string sname, string phone, string address, System.DateTime birthDay, string gender, string country) {
            if ((email == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_gender, 
                    string Original_country) {
            return this.Update(email, fname, sname, phone, address, birthDay, gender, country, Original_teacherID, Original_email, Original_fname, Original_sname, Original_address, Original_birthDay, Original_gender, Original_country, Original_teacherID);
        }
    }
